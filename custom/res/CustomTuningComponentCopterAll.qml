...
Item {
    ...
    property var pages:  [
        "CustomTuningComponentCopterRate.qml",
        "CustomTuningComponentCopterAttitude.qml",
        "CustomTuningComponentCopterVelocity.qml",
        "CustomTuningComponentCopterPosition.qml"
    ]
